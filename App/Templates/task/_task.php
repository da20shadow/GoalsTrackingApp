...
$subTasks = $taskService->getSubTasksByTaskID($task_id);
...
<!--    END PIES PROGRESS-->
    ...
    <h1 class="text-center text-secondary fw-bold my-4">Task: <?= $data->getTaskTitle() ?></h1>
    ...
    <div class="my-3 shadow-sm border border-2 rounded border-secondary">
        ...
        <textarea class="form-control" id="desc" rows="6"><?= $data->getTaskDescription() ?></textarea>
...
</svg> Subtasks: (<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-check" viewBox="0 0 16 16">
...
<!--    Subtasks List-->
    ...
    <?php foreach ($subTasks as $task): ?>
        ...
        <div class="row">
            ...
            <div class="col-6">
                <a class="text-dark" href="task.php?id=<?= $task->getSubTaskID() ?>">
