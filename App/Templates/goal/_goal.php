...
$createdOn = date("M d, Y",strtotime($data->getCreatedOn()));
...
<!--    Goal Title-->
    <p class="text-center text-warning fs-1 fw-bold mt-4">
...
<!--    Created on - due date-->
    <p class="text-center my-3 fst-italic">
...
<!--   Back Button, Goal Progress % And Days Left info-->
...
<!--        Goal Progress -->
        ...
        <?php else: ?>
            <button class="btn btn-sm btn-success border-2 shadow-sm align-middle my-2 my-md-1" >
...
<!--    Completed/Total Tasks Info-->
    <div class="d-flex flex-wrap justify-content-between mt-4">
        <span class="border border-1 p-2 mb-3 mb-md-0">
            ...
            </svg> 0 - <?= $data->getTotalTasks() ?>)
        </span>

        <button onclick="location.href='create_task.php?goal_id=<?= $data->getGoalID() ?>'"
...
<!--    Tasks List-->
    <div class="row mt-5">
        ...
        <div class="col-8 col-md-6 fw-bold fs-6">Task</div>
...
<!--            Task title-->
        <div class="col-8 col-md-6">
            ...
            <span class="badge bg-primary rounded-pill" title="Subtasks">
...
<!--            Task Status-->
        <div class="col-2 d-none d-md-block">
            ...
            <div class="btn-group">
                <button class="btn fw-bold <?= $statusColor ?>" type="button" id="dropdownStatusButton" data-bs-toggle="dropdown" aria-expanded="false">
                    <?= $status ?>
                </button>
                <ul class="dropdown-menu" aria-labelledby="dropdownStatusButton">
                    <li onclick="changeStatusToDo()" class="dropdown-item text-secondary fw-bold">
                        TO DO
                    </li>
                    <li onclick="changeStatusToProgress()" class="dropdown-item text-warning fw-bold">
                        IN PROGRESS
                    </li>
                    <li onclick="changeStatusToReview()" class="dropdown-item text-info fw-bold">
                        IN REVIEW
                    </li>
                    <li onclick="changeStatusToCompleted()" class="dropdown-item text-success fw-bold">
                            COMPLETED
                    </li>
                </ul>
            </div>
